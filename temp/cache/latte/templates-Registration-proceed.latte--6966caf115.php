<?php
// source: C:\xampp\htdocs\yotv\app\presenters/templates/Registration/proceed.latte

use Latte\Runtime as LR;

class Template6966caf115 extends Latte\Runtime\Template
{
	public $blocks = [
...
<link rel="stylesheet" href="registration.albayanmedia-africa.com/sourcefinal/css/startmin.css">
</head>
...
<div class="wrapper" >
     <nav class="navbar navbar-inverse3 navbar-fixed-top "   role="navigation" style="border-style:outset; border-width:1px; border-color:#40043d;" >
                <div class="navbar-header">
                    <a class="navbar-brand" href=""><img src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 1055 */ ?>/images/dashboad-img/urban1.jpg" width="90px" height="80px"></a>
                </div>
...
<div class="col-lg-12">
<div class=" col-lg-12" style="color:#40043d;">
<?php
	...
	function blockContent($_args)
	{
		extract($_args);
?>
<p><strong>Dear customer, we have sent you email with confirmation link. Please finish your registration by clicking on the link in the email.</strong></p>
</div>
</div>
</div>
 ...
 <div class="col-lg-12" align="right">
           <div class="w3-container">
                    <div  >
                        ...
                        <img class="mySlides w3-animate-right " src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 1110 */ ?>/images/dashboad-img/beneficiaryimg.jpg" style="width:100%">

                     <img class="mySlides w3-animate-left " src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 1112 */ ?>/images/dashboad-img/signupimg.jpg" style="width:100%">
                     <img class="mySlides w3-animate-right " src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 1113 */ ?>/images/dashboad-img/registrationimg.jpg" style="width:100%">
                      <img class="mySlides w3-animate-left " src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 1114 */ ?>/images/dashboad-img/beneficiaryimg.jpg" style="width:100%">
                </div>
  </div>
...
<div class="row">
  <div align="left" class="col-lg-7"><div class="foot" align="left">
   ...
   <h5>Powered by :</h5> 
<p style="color:#dcab21;" >albayanmedia-africa.com</p>
...
<script type="text/javascript">
	window.history.pushState([], "<test>", <?php echo LR\Filters::escapeJs($this->global->uiControl->link("proceed")) ?>);
	window.history.pushState([], "<test>", <?php echo LR\Filters::escapeJs($this->global->uiControl->link("proceed")) ?>);
	window.history.pushState([], "<test>", <?php echo LR\Filters::escapeJs($this->global->uiControl->link("proceed")) ?>);
	window.history.pushState([], "<test>", <?php echo LR\Filters::escapeJs($this->global->uiControl->link("proceed")) ?>);
	window.history.pushState([], "<test>", <?php echo LR\Filters::escapeJs($this->global->uiControl->link("proceed")) ?>);

<?php
// source: C:\xampp\htdocs\yotv\app/config/config.neon 
// source: C:\xampp\htdocs\yotv\app/config/config.local.neon 

class Container_ded89f73fe extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\SecurePresenter' => [1 => ['application.3', 'application.7']],
			'App\Presenters\HomepagePresenter' => [1 => ['application.3']],
			'App\Presenters\ProcessPresenter' => [1 => ['application.4']],
			'App\Presenters\RecoverPasswordPresenter' => [1 => ['application.5']],
			'App\Presenters\RegistrationPresenter' => [1 => ['application.6']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\ProcessPresenter',
			'application.5' => 'App\Presenters\RecoverPasswordPresenter',
			'application.6' => 'App\Presenters\RegistrationPresenter',
			'application.7' => 'App\Presenters\SecurePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\yotv\app',
			'wwwDir' => 'C:\xampp\htdocs\yotv\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\yotv\app/../temp',
			'appSettings' => ['bank_token' => 'test_pjWdRaFKbMUgvdHHTMafwgtft3SFN5'],
			'apiSettings' => [
				'url' => 'http://yotv.jacon.cz:5051/',
				'token' => 'kee7Leij',
				'test' => false,
				'secret' => 'modernitv',
			],
	...
	public function createService__24_App_Forms_NewPasswordFormControlFactory(): App\Forms\NewPasswordFormControlFactory
	{
		return new class ($this) implements App\Forms\NewPasswordFormControlFactory {
			...
			public function __construct(Container_ded89f73fe $container)
			{
	...
	public function createServiceApplication__4(): App\Presenters\ProcessPresenter
	{
	...
	public function createServiceApplication__5(): App\Presenters\RecoverPasswordPresenter
	{
	...
	public function createServiceApplication__6(): App\Presenters\RegistrationPresenter
	{
	...
	public function createServiceApplication__7(): App\Presenters\SecurePresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\yotv\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\yotv\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\yotv\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\yotv\app/../temp/cache/latte');
	...
	public function createServiceSession__session(): Nette\Http\Session
	{
		...
		$service->setOptions([
			'savePath' => 'C:\xampp\htdocs\yotv\app/../temp/session',
			'gc_probability' => 1,
			'gc_divisor' => 1000,
		]);
		return $service;

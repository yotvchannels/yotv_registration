<?php
// source: /Users/filipkuchar/Sites/yotv_project/app/config/config.neon 
// source: /Users/filipkuchar/Sites/yotv_project/app/config/config.local.neon 

class Container_2ca5186809 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/Users/filipkuchar/Sites/yotv_project/app',
			'wwwDir' => '/Users/filipkuchar/Sites/yotv_project/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/Users/filipkuchar/Sites/yotv_project/app/../temp',
	...
	public function createService__24_App_Forms_NewPasswordFormControlFactory(): App\Forms\NewPasswordFormControlFactory
	{
		return new class ($this) implements App\Forms\NewPasswordFormControlFactory {
			...
			public function __construct(Container_2ca5186809 $container)
			{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/Users/filipkuchar/Sites/yotv_project/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/Users/filipkuchar/Sites/yotv_project/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Users/filipkuchar/Sites/yotv_project/app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Users/filipkuchar/Sites/yotv_project/app/../temp/cache/latte');
	...
	public function createServiceSession__session(): Nette\Http\Session
	{
		...
		$service->setOptions([
			'savePath' => '/Users/filipkuchar/Sites/yotv_project/app/../temp/session',
			'gc_probability' => 1,
			'gc_divisor' => 1000,
		]);
		return $service;
